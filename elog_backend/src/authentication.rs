...
pub struct AuthenticatedRequest{
    ...
    pub connection: MySqlPooledConnection
}
    ...
    fn from_request(http_request: &HttpRequest, _payload: &mut dev::Payload) -> Self::Future {
        ...
        match auth {
            Some(_) => {
                ...
                let pool_from_app_data = http_request.app_data::<web::Data<MySqlPool>>();
                let connection = mysql_pool_handler(pool_from_app_data);
